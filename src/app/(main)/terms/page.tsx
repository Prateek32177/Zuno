  ...
  upon verification.
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            ...
            <li>
              ...
              during, and after attending any plan.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            ...
            <li>
              Create plans intended to defraud, exploit, or harm participants
            </li>
            <li>
              Solicit money, goods, or services from other users under false
              pretences
            </li>
            <li>Organise or promote illegal activities</li>
            <li>Post false, misleading, or deceptive plan information</li>
            <li>Distribute spam, unsolicited messages, or malicious content</li>
            <li>
              Use the platform if you are a registered sex offender or have been
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            that your content does not violate any law or third-party rights.
          </p>
        </section>

        <section>
          <h2 className="font-semibold text-base">7. Reporting obligation</h2>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            Account termination does not entitle you to any refund,
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            to: personal injury or harm arising from in-person meetups, loss of
            data, financial loss, emotional distress, or any other outcome
